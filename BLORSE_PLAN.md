...
- **The boss:** **the Hollow-Keeper** (Green Grass) — a vast old stag, **weak to a Cleric's Soothe, resistant to a Knight's Confront**, with a real tell ("it *wants* the charge…"). So a balanced, well-classed party is the puzzle, at boss scale. (`maxHp` 92; reward 120 ⬡ + a rare gem + marsh-sage.)
